...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="estilos/scss/shop.css" />
...
<nav>
  <div class="nav-shopPage">




      <ul class="mainmenu nomobile">
        <li><a href="">Tops</a><i class="material-icons nav-flecha">
          chevron_right
          </i>
          <ul class="submenu">
        ...
        <li><a href="">Pantalones</a><i class="material-icons nav-flecha">
          chevron_right
          </i>
          <ul class="submenu">
            <li><a href="">Jean</a></li>
        ...
        <li><a href="">Vestidos</a><i class="material-icons nav-flecha">
          chevron_right
          </i>
          <ul class="submenu">
        ...
        <li><a href="">Camperas</a><i class="material-icons nav-flecha">
          chevron_right
          </i>
          <ul class="submenu">
            <li><a href="">Cuero</a></li>
            <li><a href="">Jean</a></li>
            <li><a href="">Tapados</a></li>
          </ul>
        </li>
      </ul>
...
<div class="modulo-shop__descripcion">
  ...
  <div class="precio"><h4>$340</h4></div>
 <div class="color"><h4>COLOR +</h4></div>
</div>
</div>
<div class="modulo-shop">
    <div class="modulo-shop__img">
